...
pcl::PointCloud<PointTObj>::Ptr ObjectSegmentationPlane::getFiltered( pcl::PointCloud<PointTObj>::Ptr p_cloudInput ){
    ...
    float minX = -0.5, maxX = 0.5, minY = -0.5, maxY = 0.3, minZ = 0.5, maxZ = 1.6;
    cloudOutput =  processingPcd.getPassThrough( p_cloudInput, minX, maxX, minY, maxY, minZ, maxZ);

//    std::stringstream ss;
//    ss << "/home/gkerabat/Documents/Project/DataSets/Kinect/Brick/Registration_17-27-08_new/SegPointClouds/cloud1.pcd";
...
bool ObjectSegmentationPlane::getPlaneIndicesAndCoeffSAC( pcl::PointCloud<PointTObj>::Ptr p_cloudInput, pcl::PointIndices::Ptr p_indices, pcl::ModelCoefficients::Ptr p_modelCoeff ){
    ...
    sacSeg.setAxis( Eigen::Vector3f( 0.0, 0.0, 1.0 ) );
    sacSeg.setEpsAngle( 10.0f * (3.14/180.0f));
...
std::vector<pcl::PointIndices> ObjectSegmentationPlane::getClusters (pcl::PointCloud<PointTObj>::Ptr p_cloudInput ){
    ...
    euclideanClustExtraction.setClusterTolerance( 0.05 ); //0.02 for brick //0.5 //less tolerance more clusters
    euclideanClustExtraction.setMinClusterSize( 300 );
...
//        std::stringstream ss;
//        ss << "/home/gkerabat/Documents/Project/DataSets/Kinect/Box1/SegpointClouds/cloudCluster_" << j << ".pcd";
